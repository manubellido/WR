...
class SelectWithEmptyLabelForEnumerations(Select):

    def __init__(self, attrs=None, choices=None, empty_label='-------'):
        if choices:
            choices = choices.clone()
            choices.insert(0, (0, 'EMPTY', empty_label, ))
        super(SelectWithEmptyLabelForEnumerations, self).__init__(
            attrs, choices
        )
