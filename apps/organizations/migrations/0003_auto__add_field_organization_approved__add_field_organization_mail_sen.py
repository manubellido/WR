...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organization.approved'
        db.add_column('organizations_organization', 'approved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Organization.mail_sent'
        db.add_column('organizations_organization', 'mail_sent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organization.approved'
        db.delete_column('organizations_organization', 'approved')

        # Deleting field 'Organization.mail_sent'
        db.delete_column('organizations_organization', 'mail_sent')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 1, 16, 47, 24, 73546)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 1, 16, 47, 24, 73440)'}),
